export class Corridor {
  ...
  constructor(roomStart, roomEnd) {
    this.start = { room: roomStart };
    this.end = { room: roomEnd };
    this.setDoors();
  }
  ...
  setSegments(orientation) {
    ...
    if (orientation === 'horizontal') {
      ...
      this.segments[1].fieldX = (this.end.room.fieldX + this.end.x - this.segments[0].fieldX) / 2 < 0 ? this.segments[0].fieldX : this.segments[0].fieldX + this.segments[0].width;
      ...
      this.segments[1].fieldY = (this.end.room.fieldY + this.end.y - this.segments[0].fieldY) / 2 < 0 ? this.segments[0].fieldY : this.segments[0].fieldY + this.segments[0].height;
