...
export function PerformanceStats() {
  ...
  return (
    <div className="absolute top-4 right-4 bg-black/80 dark:bg-black/80 text-white p-3 rounded-lg font-mono text-xs space-y-1 min-w-[180px] pointer-events-auto">
