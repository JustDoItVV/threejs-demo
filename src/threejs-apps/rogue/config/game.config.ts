...
export const Items: Record<string, Record<string, ItemConfig>> = {
  treasure: {
    gold: {
      ch: '⛁',
      color: 'yellow',
...
// Legacy constants from terminal visualization with blessed lib "blessed"
// These are no longer used in the current Three.js implementation
